...
public class PersonaJdbcException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepci�n.
	 */
	public PersonaJdbcException() {
		super();
	}
	 ...
	 */
	public PersonaJdbcException(String message) {
		super(message);
	}
	 ...
	 */
	public PersonaJdbcException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public PersonaJdbcException(Throwable cause) {
		super(cause);
	}
}
