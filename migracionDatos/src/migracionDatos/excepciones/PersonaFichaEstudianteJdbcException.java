...
public class PersonaFichaEstudianteJdbcException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepci�n.
	 */
	public PersonaFichaEstudianteJdbcException() {
		super();
	}
	 ...
	 */
	public PersonaFichaEstudianteJdbcException(String message) {
		super(message);
	}
	 ...
	 */
	public PersonaFichaEstudianteJdbcException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public PersonaFichaEstudianteJdbcException(Throwable cause) {
		super(cause);
	}
}
