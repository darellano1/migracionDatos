...
public class ConsutaGeneralJdbcException extends Exception{
	private static final long serialVersionUID = -3995370847716513453L;

	/**
	 * Constructor por defecto de la excepci�n.
	 */
	public ConsutaGeneralJdbcException() {
		super();
	}
	 ...
	 */
	public ConsutaGeneralJdbcException(String message) {
		super(message);
	}
	 ...
	 */
	public ConsutaGeneralJdbcException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @see java.lang.Throwable
	 */
	public ConsutaGeneralJdbcException(Throwable cause) {
		super(cause);
	}
}
